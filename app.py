...
ALL_NEWS = [
    {
        ...
        "full_detail": "เนื้อหาแบบละเอียด: เรื่องราวเกิดขึ้นในประเทศญี่ปุ่นยุคไทโช คามาโดะ ทันจิโร่ เป็นเด็กหนุ่มผู้มีจิตใจดีงามและขยันขันแข็ง วันหนึ่งเขาได้ออกไปขายถ่านแต่เมื่อกลับมาบ้านกลับพบว่าครอบครัวของเขาถูกอสูรฆ่าตายทั้งหมด เหลือเพียง เนซึโกะ น้องสาวคนเดียวที่รอดชีวิตแต่เธอก็ได้กลายเป็นอสูรไปเสียแล้ว ทันจิโร่จึงตัดสินใจเข้าฝึกฝนเพื่อเป็นนักล่าอสูร หาทางช่วยให้น้องสาวกลับมาเป็นมนุษย์อีกครั้ง และออกเดินทางเพื่อล้างแค้นให้อสูรที่ทำลายครอบครัวของเขา...",
